...
var back_button_meet_with_us = document.querySelector(".back-button-meet-with-us");
var meetWithUsForm = document.querySelector(".meet-with-us-form");
...
back_button_meet_with_us.addEventListener("click", function() {
    meetWithUsForm.style.display = "none";
