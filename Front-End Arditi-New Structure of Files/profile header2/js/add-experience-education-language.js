...
// // var exp_delete_popup = document.querySelector(".delete-experience");
// // var education_delete_popup = document.querySelector(".delete-education");
...
//     $(add).siblings().css("display", "none");
//     document.body.style.overflow = "hidden";
// });

// btn2.addEventListener('click', function() {
//     $(mainDiv).css("display", "flex");
//     $(underBg).css("display", "block");
//     $(underBg).siblings().css("display", "none");
//     document.body.style.overflow = "hidden";
// });

// btn3.addEventListener('click', function() {
//     $(mainDiv).css("display", "flex");
//     $(uBgEducation).css("display", "block");
//     $(uBgEducation).siblings().css("display", "none");
//     document.body.style.overflow = "hidden";
// });

// function deleteUserLanguages() {
