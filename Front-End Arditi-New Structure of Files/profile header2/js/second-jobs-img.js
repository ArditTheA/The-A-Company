...
var education_all_applicants = document.querySelector(".experience-main-div");
const firstMediaQuery = window.matchMedia('(min-width: 948px');
const mediaQuery = window.matchMedia('(max-width: 947px)');
