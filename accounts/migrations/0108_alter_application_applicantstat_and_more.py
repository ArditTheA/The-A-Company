...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='jobs',
            name='deadline',
            field=models.DateField(blank=True, default=datetime.datetime(2023, 5, 31, 8, 28, 1, 71176), null=True),
        ),
        migrations.AlterField(
            model_name='jobs',
            name='housing',
        ...
        migrations.AlterField(
            model_name='jobs',
            name='postDate',
            field=models.DateField(blank=True, default=datetime.datetime(2023, 5, 31, 8, 28, 1, 71210), null=True),
        ),
        migrations.AlterField(
            model_name='jobs',
            name='program',
        ...
        migrations.AlterField(
            ...
            name='level',
            field=models.CharField(choices=[('Low-Intermediate', 'Low-Intermediate'), ('Advanced', 'Advanced'), ('Basic', 'Basic'), ('N/A', 'N/A'), ('High-Intermediate', 'High-Intermediate')], max_length=255),
        ),
    ]
