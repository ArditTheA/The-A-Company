...
secondsearchInput.classList.add("search-input");   // the problem (plus button on higher position than search input) is: "search-input"

secondsearchInput.classList.add("inputs-right-margin");


secondsearchInput.style.paddingLeft = "20px";
secondsearchInput.style.width = "105px";
secondsearchInput.placeholder = "Add a phase";
...
function add_phase(){
    ...
    input_form.classList.add("input-form-all-applicants");
    input_form.classList.add("inputs-right-margin");
    Inputform.appendChild(input_form);
    let under_input_div = document.createElement("div");
    under_input_div.style.display = "flex";
    input_form.appendChild(under_input_div);
