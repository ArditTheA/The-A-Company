    ...
    async function recruiterJobs(id) {
        ...
        if(data["StatusApp"]){
            if(data["StatusApp"] != "Qualified"){
                ...
                $(".second-screening-question-div").removeClass("divs-pointer-event-auto");

            }else{
                $(".second-screening-question-div").addClass("divs-pointer-event-auto");
            }
        }
